...
export default ({ openModal, handleClose, handleSubmit }) => {
  const { modal, modalHeader, controlStyle, textStyle, licenseButtons, line, image } = useStyles()
  return (
    <Modal
      handleClose={handleClose}
      isOpen={openModal}
    >
      <div dataTest='modal-remove-manager'>
        <div className={modal}>
          <div className={modalHeader}>
            ...
            <div className={controlStyle}>
              ...
              <div className={textStyle}>
                <TypographyElement component='h2' variant='heading2' fontSize='24px' align='left' display='inline' lineHeight='0px' spacing='10px 8px 0 0' color={blue[0]}>
                  {Text.dot}
                </TypographyElement>
                <TypographyElement component='h4' variant='caption2' align='left' display='inline' spacing='10px 0 0 0' lineHeight='25px' color={neutral[4]}>
                  {Text.noAccess}
                </TypographyElement>
              </div>
              <TypographyElement component='h2' variant='heading2' fontSize='14px' align='left' lineHeight='25px' spacing='16px 0 5px 0' color={neutral[5]}>
          ...
          <div className={controlStyle}>
            ...
            <div className={licenseButtons}>
              ...
              <Button
                ...
                dataTest='remove-manager-confirm-button'
              />
            </div>
          </div>
        </div>
